...
const PollingStation = (props) => {
	const [candidateName1URL, changeCandidate1Url] = useState(LoadingCircles);
	const [candidateName2URL, changeCandidate2Url] = useState(LoadingCircles);
